...
pris = (('grodno_tec2_devatovka', 'grodno_tec2_devatovka.tex', 'Протокол профвосстановления РЗА ВЛ-110кВ Девятовка Гродненской ТЭЦ-2', '23.09.2023'),
        ...
        ('rechica_bgpz_dzo1', '', 'Протокол наладки 1 комплекта ДЗО и УРОВ на ПС 110кВ БГПЗ', '15.01.2024'),
        ('rechica_bgpz_dzo2', '', 'Протокол наладки 2 комплекта ДЗО и УРОВ на ПС 110кВ БГПЗ', '15.01.2024'))
num = 4
today = pris[num][3]
root_doc = pris[num][0]
language = 'ru'
